<?php 
  ...
  if($res->num_rows>0){
	  ...
	  $obj=new MoroccoCurrency($row["GRAND_TOTAL"]);
  ...
  class PDF extends FPDF
  {
    function Header(){
      ...
      $this->Cell(50,10,"BOUSSIF SUPERMARKET",0,1);
      $this->SetFont('Arial','',14);
      $this->Cell(50,7,"Administrative Street,",0,1);
      $this->Cell(50,7,"Said 636002.",0,1);
      $this->Cell(50,7,"PHONE : +212612345678",0,1);
    ...
    function Footer(){
      ...
      $this->SetY(-50);
      $this->SetFont('Arial','B',12);
      $this->Cell(0,10,"for BOUSSIF SUPERMARKET",0,1,"R");
      $this->Ln(15);
      $this->SetFont('Arial','',12);
